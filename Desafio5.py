...
#Faça um programa que leia um número e mostrena tela a sua tabuada#
#Crie um programa que leia quanto dinheiro tenho na carteira e mostre quantos dólares ela pode comprar#
